...
import { categoryApi, CategoriesResponse, GetCategoriesParams } from '../lib/api/category'
...
export const useBlogCategories = (params?: GetCategoriesParams, initialData?: CategoriesResponse) => {
